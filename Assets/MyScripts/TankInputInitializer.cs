    ...
    private void SetypControlsByType()
    {
        switch (_iDSettingsCS.PlayerType)
        {
            ...
            case EPlayerType.Player:
                ...
                _aimingControlType       = new Aiming_Control_Input_02_For_Single_Stick_Drive_CS(_playerInput, _newControl.TankMovement.ResetTurret, _newControl.TankMovement.Look);
