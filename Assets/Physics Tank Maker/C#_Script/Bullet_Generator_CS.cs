    ...
    public class Bullet_Generator_CS : MonoBehaviour
    {
		...
		*/
        ...
        IEnumerator Generate_Bullet()
        {
            ...
            // Generate the bullet.
            Bullet_Control_CS bulletObject;
            float attackPoint = 0;
            switch (currentBulletType)
            {
                case 0: // AP
                ...
                case 1: // HE
                    ...
                    bulletObject = Instantiate(HE_Bullet_Prefab, thisTransform.position + (thisTransform.forward * Offset), thisTransform.rotation).GetComponent<Bullet_Control_CS>();
            ...
            bulletObject.Life_Time = Life_Time;
            bulletObject.Attack_Multiplier = Attack_Multiplier;
